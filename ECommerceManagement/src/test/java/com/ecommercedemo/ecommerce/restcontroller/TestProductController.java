...
public class TestProductController {
	...
	/*
	 * @Test public void getProductsTest() {
	 * 
	 ...
	 * products.size());
	 * 
	 * Mockito.when(productServiceImpl.getProducts(product.getProductName())).
	 * thenReturn(productResponse);
	 * 
	 * ResponseEntity<ProductResponse> responseEntity =
	 * productController.getProducts(product.getProductName());
	 * 
	 * assertEquals(productResponse.getProductListSize(),
	 * responseEntity.getBody().getProductListSize());
	 * 
	 * assertEquals(productResponse.getProducts(),
	 * responseEntity.getBody().getProducts());
	 * 
	 * }
	 */
